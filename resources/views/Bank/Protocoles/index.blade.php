                        ...
                        <tr>
                            <td>
                                <div>
                                    ...
                                    <a style="vertical-align:middle" href="#">{{ $item->cooperative?$item->cooperative->name:'-' }}</a>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                       <li><a class="dropdown-item" href="{{ route('bank.protocoles.show',$item->token) }}">Afficher</a></li>
