...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active" aria-current="page">Liste des offres commerciales</li>
    </ol>
 </nav>
@endsection
...
@section('page-header')
    <div>
        <h5 class="page-title mb-0 mt-2">Offres commerciales </h5>
        <p class="lead">Liste des offres commerciales </p>
    </div>
@endsection
                ...
                <tbody>
                    @foreach($items as $item)
                        <tr>
                            ...
                            <td><a href="{{ $item->precommande?route('bank.commandes.show',$item->precommande->token):'#' }}">{{ $item->precommande?$item->precommande->name:'-' }}</a></td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                       <li><a class="dropdown-item" href="{{ route('bank.invoices.show',$item->token) }}">Afficher</a></li>
