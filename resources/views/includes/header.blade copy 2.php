...
<head>
    ...
    <meta name="description" content="Plateforme Keka de gestion de la collecte de la feve au Cameroun.">
    <title>@yield('title') | KEKA</title>
        ...
        <section id="content" class="content">
            ...
            <footer class="content__boxed mt-auto">
                <div class="content__wrap py-3 py-md-1 d-flex flex-column flex-md-row align-items-md-center">
                    <div class="text-nowrap mb-4 mb-md-0">Copyright &copy; {{ date('Y') }} <a href="#" class="ms-1 btn-link fw-bold">Keka</a></div>
            ...
            <div class="header__inner">
                ...
                <div class="header__brand">
                    <div class="brand-wrap">
                        ...
                        <!-- Brand title -->
                        <div class="brand-title">KEKA</div>
