...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active" aria-current="page">Suivi des transactions</li>
    </ol>
 </nav>
@endsection
...
@section('page-header')
    <div>
        <h5 class="page-title mb-0 mt-2">Suivi des transactions</h5>
        <p class="lead">Centrale de suivi de toutes les transactions du bassin </p>
    </div>
@endsection
