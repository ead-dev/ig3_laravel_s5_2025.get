...
class ProtocoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('/Admin/Protocoles/index')->with(compact('protocoles','cooperatives','saisons'));
    }
    ...
    public function showCalendarItem($token){
        ...
        return view('/Admin/Protocoles/calendar_item')->with(compact('item','arrondissements','contrats'));
	...
	public function show($id)
	{
        ...
        $regions = Region::all();
		return view('/Admin/Protocoles/show')->with(compact('protocole','regions'));
	}
