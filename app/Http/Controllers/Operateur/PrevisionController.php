...
class PrevisionController extends Controller
{
    ...
    public function index()
    {
        ...
        $day = request()->day;
        if($day){
            $previsions = Prevision::where('day',$day)->get();
            return view('/Operateur/Previsions/index')->with(compact('previsions','day'));
        }
        $previsions = Prevision::orderBy('day','DESC')->where('saison_id',$this->_saison->id)->get();

        return view('/Operateur/Previsions/index')->with(compact('previsions'));
    }

    public function getCalendarData(){
        $previsions = Prevision::orderBy('day','ASC')->where('saison_id',$this->_saison->id)->get();
	...
	public function show($id)
	{
		...
		return view('/Operateur/Previsions/show')->with(compact('prevision'));
	}
