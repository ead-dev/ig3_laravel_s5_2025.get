...
class ProtocoleController extends Controller
{
    ...
    public function index()
    {
        ...
        $protocoles = $protocoles->filter(function($item){
            return $item->cooperative->departement_id == auth()->user()->departement_id;
        });
        return view('/RBassin/Protocoles/index')->with(compact('protocoles','cooperatives','saisons'));
    }
	...
	public function show($token)
	{
		$protocole = Protocole::where('token',$token)->first();
        $regions = Region::all();
		return view('/RBassin/Protocoles/show')->with(compact('protocole','regions'));
	}
